...
#include "rrand.h"//rrand(a,b) generuoja reiksmes siame intervale pasitelkus funkcijos duotus 2 globalius kintamuosius
#include "struct.h"
#include "funkcijos.h"
...
int main()//main susidaro is kintamuju sukurimo, ivesties, blogos ivesties filtravimas su try-catch ir meniu, panaudojancio ivesti.
{
    ...
    while(a)//norejau loop, bet nenorejau inversijos
    {
        ...
        catch(std::string& a)//suprantu, kad man net nereik perduoti z2, nes jis vis dar prieinamas, bet nemokejau nenaudot kintamojo
        {//nesupratau dalies, apie reikme naudot vienodus duom failus. Suprantu del ko reiketu, bet ne kaip tai pasiekti.
            cout<<a<<" nera tinkama ivestis"<<endl;
        }//nera geras try-catch pritaikymas, nes tai galejau pasiekt naudojant ir if'us.
    }//skaiciau apie exception'us bet neismokau ju normaliai pritaikyt.
    return 0;
}
